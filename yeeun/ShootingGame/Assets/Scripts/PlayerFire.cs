...
public class PlayerFire : MonoBehaviour
{
    ...
    public List<GameObject> bulletObjectPool; // 오브젝트 풀 리스트 
    ...
    void Start()
    {
        ...
        for(int i=0; i<poolSize; i++){
            ...
            bulletObjectPool.Add(bullet); // 리스트  삽입 => Add함수 사용
    ...
    void Update()
    {
        ...
        if(Input.GetButtonDown("Fire1")){
            // 리스트 오브젝트 풀 => 비활성화 상태의 총알만 있기 때문에 배열과 다르게 활성화 여부 확인을 위해 전수조사 필요X
